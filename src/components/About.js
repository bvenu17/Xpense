        ...
        <div className="container container1">
         ...
         <br></br>
            ...
            <div className="row locationCardRow post">
                ...
                <div className="col-lg-6 col-md-6 col-sm-6 locationCard">
                    <img class = "aboutImg" src="/imgs/newjersey.jpg" alt="img" />
                </div>
            </div>
            <div className="row locationCardRow post">
                <div className="col-lg-6 col-md-6 col-sm-6 locationCard">
                    <img class = "aboutImg" src="/imgs/newyork.jpg" alt="img" />
                </div>
                <div className="col-lg-6 col-md-6 col-sm-6 locationCard">
                    <div className="locationDes">
            ...
            <div className="row">
                ...
                <div className="col-lg-2 col-md-4 col-sm-4">
                    <div className="devCard post">
                        <img class = "aboutImg" src="/imgs/vedadnya.jpg" class = "avatarPic2" alt="img" />
                ...
                <div className="col-lg-2 col-md-6 col-sm-6">
                    <div className="devCard post">
                        <img class = "aboutImg" src="/imgs/venu.jpg" class = "avatarPic2" alt="img" />
                ...
                <div className="col-lg-2 col-md-6 col-sm-6">
                    <div className="devCard post">
                        <img class = "aboutImg" src="/imgs/chirag.jpg" className = "avatarPic2" alt="img" />
                ...
                <div className="col-lg-2 col-md-6 col-sm-6">
                    <div className="devCard post">
                        <img class = "aboutImg" src="/imgs/rohan.jpg" class = "avatarPic2" alt="img" />
                ...
                <div className="col-lg-2 col-md-6 col-sm-6">
                    <div className="devCard post">
                        <img class = "aboutImg" src="/imgs/harish.jpg" className = "avatarPic2" alt="img" />
